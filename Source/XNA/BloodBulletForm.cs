...
namespace BloodBullet
{
	class BloodBulletForm : Form
	{
		...
		protected override void WndProc( ref Message p_Message )
		{
	...
	class Win32
	{
		...
		public static extern bool PeekMessage( out NativeMessage p_Message,
			IntPtr p_Window, uint p_MessageFilterMinimum,
			uint p_MessageFilterMaximum, uint p_ShouldRemoveMessage );

		[DllImport( "user32.dll" )]
		public static extern bool TranslateMessage( [In] ref NativeMessage p_Message );

		[DllImport( "user32.dll" )]
		public static extern IntPtr DispatchMessage( [In] ref NativeMessage p_Message );
	}
